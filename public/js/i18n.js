...
export const translations = {
  ar: {
    ...
    'verify.verifying': 'جارٍ تفعيل بريدك الإلكتروني…',
    'verify.success': 'تم تفعيل حسابك بنجاح ✓',
    'verify.redirecting': 'يتم تحويلك الآن…',
    'verify.failed': 'تعذّر تفعيل الحساب. قد يكون الرابط منتهي الصلاحية.',
    'verify.noToken': 'رابط التفعيل غير صالح أو ناقص.',
    'verify.toLogin': 'تسجيل الدخول',
    'verify.toRegister': 'إنشاء حساب جديد',
  ...
  en: {
    ...
    'verify.success': 'Your account is verified ✓',
    'verify.redirecting': 'Redirecting…',
    'verify.failed': 'Verification failed. The link may have expired.',
    'verify.noToken': 'Invalid or missing verification link.',
    'verify.toLogin': 'Sign in',
